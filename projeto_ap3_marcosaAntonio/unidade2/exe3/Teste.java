...
public class Teste {
    public static void main(String[] args) {
        ...
        Universidade universidade1 = new Universidade("Universidade universodo saber", cursosUniversidade1);
        Universidade universidade2 = new Universidade("Universidade aprendiz", cursosUniversidade2);
        Universidade universidade3 = new Universidade("Universidade famosa", cursosUniversidade3);
